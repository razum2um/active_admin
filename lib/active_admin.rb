...
module ActiveAdmin
  ...
  autoload :CrudDecorator,            'active_admin/crud_decorator'
  autoload :CrudCollectionDecorator,  'active_admin/crud_collection_decorator'
  autoload :CrudResource,             'active_admin/crud_resource'
  autoload :CrudResourceController,   'active_admin/crud_resource_controller'
